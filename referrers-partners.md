...
4. change the billing email to the client’s email, so that the client will receive email reminders to enter their payment method at the end of the free trial period (here is a [help article with images](https://support.stratapp.ai/portal/en/kb/articles/settings-billing-changing-the-billing-contact "help article on changing the billing contact") on how to do that)
5. email sales@stratapp.ai to register the lead per the Registration Process above
